...
def obtenerProgreso(event, context):
  ...
  QUERY = ('DELETE FROM my-project-83697-juan-carlos.datosCustomerSuccess.tablaProgreso WHERE id IS NOT NULL')
  ...
  message_payload = "Lanzar ObtenerProgreso2"
  future = publisher.publish("projects/my-project-83697-juan-carlos/topics/triggerObtenerProgreso", data=message_payload.encode('utf-8'))
  future.result()
