...
def obtenerAlumnos(event, context):
  ...
  QUERY = ('DELETE FROM my-project-83697-juan-carlos.datosCustomerSuccess.tablaAlumnos WHERE id IS NOT NULL')
  ...
  future = publisher.publish("projects/my-project-83697-juan-carlos/topics/triggerObtenerAlumnos-PubSub2", data=message_payload.encode('utf-8'))
  future.result()
